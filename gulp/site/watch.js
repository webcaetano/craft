...
module.exports = function(options) {
	gulp.task('fullReload:site',gulp.series('inject:site','template', function watch(done){
		browserSync.reload();
		done();
	}));

	gulp.task('watch:site', gulp.series('inject:site','template',gulp.parallel('scripts:site:watch'), function watch(done) {
